...
process.treeProducer.pileupMCFile = cms.FileInPath('EffAnalyzer/TreeProducer/data/pileup_mc.root')
process.treeProducer.pileupDataFile = cms.FileInPath('EffAnalyzer/TreeProducer/data/pileup_data16BCG_PPSruns_v2.root')
